"use strict"
{
  ...
  const quizSet = [
    ...
    {q: '（中級：20点）スプラッシュマウンテンは主人公のウサギどんがあるモノを探しに旅に出ていくという設定のアトラクションです。ではそのあるモノとは次のうちどれ?', c: ['笑いの国', '自由の国', '幸せの国']},
    {q: 'スプラッシュマウンテンは昔小さな丘でしたが、ある人物によって水浸しにされてしまいました。ではその人物は次のうちどれでしょう?', c: ['アライグマのラケッティ', 'ビーバーブラザーズ', 'クマのブレアベア']},
    {q: 'アトラクション・スプラッシュマウンテンでは落下中に写真撮影があります。ではその写真を撮影をしている動物は次のうちどれでしょう?', c: ['ホタル', 'カメ', 'カエル']},
